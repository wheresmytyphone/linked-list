...
function addCard(card) {
  ...
  $('aside').prepend(`<div class="linked-card"><div><h3 class="web-title">${websiteTitle}</h3><hr><a href="${websiteUrl}" class="web-url">${websiteUrl}</a><hr></div><p class="action unread">Read</p><p class="action delete">Delete</p></div>`);
}
